    ...
    <main id="top">
      ...
      <section className="content-section" id="projects">
        ...
        <div className="project-list">{visible.map((project, index) => <article className="project-card" key={project.id}>
          ...
          {(project.githubUrl || project.siteUrl) && <div className="project-links">{project.githubUrl && <a className="project-github" href={project.githubUrl} target="_blank" rel="noreferrer">GitHub 저장소 ↗</a>}{project.siteUrl && <a className="project-github" href={project.siteUrl} target="_blank" rel="noreferrer">사이트 방문 ↗</a>}</div>}
